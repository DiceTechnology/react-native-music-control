...
- (MPRemoteCommandHandlerStatus)onChangePlaybackPosition:(MPChangePlaybackPositionCommandEvent*)event { [self sendEventWithValue:@"changePlaybackPosition" withValue:[NSString stringWithFormat:@"%.15f", event.positionTime]]; return MPRemoteCommandHandlerStatusSuccess; }
...
- (MPRemoteCommandHandlerStatus)onSkipBackward:(MPRemoteCommandEvent*)event { [self sendEvent:@"skipBackward"];  return MPRemoteCommandHandlerStatusSuccess;}
- (MPRemoteCommandHandlerStatus)onSkipForward:(MPRemoteCommandEvent*)event { [self sendEvent:@"skipForward"];  return MPRemoteCommandHandlerStatusSuccess;}
